        ...
        outputMessages=TRUE, naturalVariation=95)
{
    ...
    if(numberofgenders==2){        
        ...
        GenotypeSubset_males <- subset(GenotypeControlSubset, 
                GenotypeControlSubset$Gender=="Male")
        ...
        GenotypeSubset_males <- subset(GenotypeMutantSubset, 
                    GenotypeMutantSubset$Gender=="Male")                      
        ...
        GenotypeSubset_females <- subset(GenotypeControlSubset, 
                GenotypeControlSubset$Gender=="Female")
        ...
        GenotypeSubset_females <- subset(GenotypeMutantSubset, 
                    GenotypeMutantSubset$Gender=="Female")            
    ...
    # Matrices for combined datasets or one gender only
