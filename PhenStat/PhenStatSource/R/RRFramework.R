        ...
        outputMessages=TRUE, naturalVariation=95, controlPointsThreshold=60)
{
    ...
    ES_all <- round(max(ES_matrix_all[1,3],ES_matrix_all[3,3]),digits=0)
    ...
    # Matrices for males/females only datasets
    if(numberofsexes==2){       
        ...
        ES_male <- round(max(ES_matrix_male[1,3],ES_matrix_male[3,3]),digits=0)
        ...
        ES_female <- round(max(ES_matrix_female[1,3],ES_matrix_female[3,3]),digits=0)
