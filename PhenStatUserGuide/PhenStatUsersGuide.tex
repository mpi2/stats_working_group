...
The example of bar plot is shown in Figure \ref{fig:05}.
\begin{figure}[!htpb]%figure01
...
\subsection{Graphics for Continous Data}
There is a bunch of graphic functions for the MM framework results. They can be divided into two main categories: dataset based graphs, results based graphs.
...
The example of bar plot split by gender and genotype is shown in Figure \ref{fig:06}.
\begin{figure}[!htpb]%figure01
...
The example of bar plot split by gender, genotype and batch is shown in Figure \ref{fig:07}.
\begin{figure}[!htpb]%figure01
...
The example of scatter plot of body weight versus dependent variable is shown in Figure \ref{fig:08}.
\begin{figure}[!htpb]%figure01
...
The example of Q-Q plot of residuals for each genotype is shown in Figure \ref{fig:09}.
...
The example of Q-Q plot of blups (best linear unbiased predictions) is shown in Figure \ref{fig:10}.
...
The example of Q-Q plot of rotated residuals is shown in Figure \ref{fig:11}.
